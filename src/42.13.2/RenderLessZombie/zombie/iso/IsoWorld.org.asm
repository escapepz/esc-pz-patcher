...
.class public final super zombie/iso/IsoWorld {
    ...
    .method public LoadTileDefinitions (Lzombie/iso/sprite/IsoSpriteManager;Ljava/lang/String;I)V {
        ...
        exceptions: { 
            { E, TT, TU, Ljava/lang/Throwable; }, 
            { TV, TW, TX, Ljava/lang/Throwable; }, 
            { D, TZ, UA, Ljava/lang/Throwable; }, 
            { UB, UC, UD, Ljava/lang/Throwable; }, 
            { C, UF, UG, Ljava/lang/Exception; }
         },
        code: {
        A: 
            line 614
        ...
        B: 
            ...
            istore bPatch
        C: 
            // try-start:   range=[C-UF] handler=UG:java/lang/Exception 
            line 618
            ...
            astore fis
        D: 
            // try-start:   range=[D-TZ] handler=UA:java/lang/Throwable 
            ...
            astore in
        E: 
            // try-start:   range=[E-TT] handler=TU:java/lang/Throwable 
            line 619
            aload in
        ...
        TS: 
            ...
            invokevirtual zombie/debug/DebugLogStream.debugln (Ljava/lang/Object;)V
        TT: 
            // try-end:     range=[E-TT] handler=TU:java/lang/Throwable 
            line 1294
            aload in
            invokevirtual java/io/BufferedInputStream.close ()V
            goto TZ
        TU: 
            // try-handler: range=[E-TT] handler=TU:java/lang/Throwable 
            line 618
            astore v7
        TV: 
            // try-start:   range=[TV-TW] handler=TX:java/lang/Throwable 
            aload in
            invokevirtual java/io/BufferedInputStream.close ()V
        TW: 
            // try-end:     range=[TV-TW] handler=TX:java/lang/Throwable 
            goto TY
        TX: 
            // try-handler: range=[TV-TW] handler=TX:java/lang/Throwable 
            astore v8
            aload v7
            aload v8
        ...
        TY: 
            ...
            athrow 
        TZ: 
            // try-end:     range=[D-TZ] handler=UA:java/lang/Throwable 
            line 1294
            aload fis
            invokevirtual java/io/FileInputStream.close ()V
            goto UF
        UA: 
            // try-handler: range=[D-TZ] handler=UA:java/lang/Throwable 
            line 618
            astore v6
        UB: 
            // try-start:   range=[UB-UC] handler=UD:java/lang/Throwable 
            aload fis
            invokevirtual java/io/FileInputStream.close ()V
        UC: 
            // try-end:     range=[UB-UC] handler=UD:java/lang/Throwable 
            goto UE
        UD: 
            // try-handler: range=[UB-UC] handler=UD:java/lang/Throwable 
            astore v7
            aload v6
            aload v7
            invokevirtual java/lang/Throwable.addSuppressed (Ljava/lang/Throwable;)V
        UE: 
            ...
            athrow 
        UF: 
            // try-end:     range=[C-UF] handler=UG:java/lang/Exception 
            line 1296
            goto UI
        UG: 
            // try-handler: range=[C-UF] handler=UG:java/lang/Exception 
            line 1294
            astore ex
        UH: 
            line 1295
