...
implements IDebugOptionGroup {
    ...
    public final BooleanDebugOption[] threadCrashGameThread = new BooleanDebugOption[]{this.newDebugOnlyOption("ThreadCrash.MainThread.0", false), this.newDebugOnlyOption("ThreadCrash.MainThread.1", false), this.newDebugOnlyOption("ThreadCrash.MainThread.2", false)};
    public final BooleanDebugOption[] threadCrashRenderThread = new BooleanDebugOption[]{this.newDebugOnlyOption("ThreadCrash.RenderThread.0", false), this.newDebugOnlyOption("ThreadCrash.RenderThread.1", false), this.newDebugOnlyOption("ThreadCrash.RenderThread.2", false)};
    public final BooleanDebugOption[] threadCrashGameLoadingThread = new BooleanDebugOption[]{this.newDebugOnlyOption("ThreadCrash.GameLoadingThread.0", false)};
    ...
    public final BooleanDebugOption thumpableBarricadeCurrentCellWindowsFullPlanks = this.newDebugOnlyOption("Thumpable.IsoBarricade.BarricadeCurrentCellWindows.FullPlank", false);
    public final BooleanDebugOption thumpableBarricadeCurrentCellWindowsHalfPlanks = this.newDebugOnlyOption("Thumpable.IsoBarricade.BarricadeCurrentCellWindows.HalfPlank", false);
    public final BooleanDebugOption thumpableBarricadeCurrentCellWindowsFullMetalBars = this.newDebugOnlyOption("Thumpable.IsoBarricade.BarricadeCurrentCellWindows.FullMetalBars", false);
    public final BooleanDebugOption thumpableBarricadeCurrentCellWindowsMetalPlate = this.newDebugOnlyOption("Thumpable.IsoBarricade.BarBarricadeCurrentCellWindows.MetalPlate", false);
    public final BooleanDebugOption thumpableRemoveBarricadeCurrentCellWindows = this.newDebugOnlyOption("Thumpable.IsoBarricade.RemoveBarricadeCurrentCellWindows", false);
    ...
    private void initMessaging() {
        if (triggerWatcher == null) {
            triggerWatcher = new PredicatedFileWatcher(ZomboidFileSystem.instance.getMessagingDirSub("Trigger_SetDebugOptions.xml"), this::onTrigger_SetDebugOptions);
    ...
    private void addOption(IDebugOption newOption) {
        if (newOption instanceof BooleanDebugOption) {
            BooleanDebugOption boolOption = (BooleanDebugOption)newOption;
            this.options.add(boolOption);
        }
        if (newOption instanceof IDebugOptionGroup) {
            IDebugOptionGroup group = (IDebugOptionGroup)newOption;
    ...
    public void load() {
        ...
        if (configFile.read(fileName)) {
            for (int i = 0; i < configFile.getOptions().size(); ++i) {
                ...
                BooleanDebugOption myOption = this.getOptionByName(configOption.getName());
                if (myOption == null) continue;
                ((ConfigOption)myOption).parse(configOption.getValueAsString());
            }
        }
    }
